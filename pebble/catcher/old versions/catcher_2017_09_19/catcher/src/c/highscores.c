...
void init_muestra_highscores(Window *pwindow) {
  ...
  int i,y,lalto;
    ...
    text_layer_set_font(s_highscores_titulo, fonts_get_system_font(FONT_KEY_GOTHIC_18_BOLD));
    ...
    text_layer_set_font(s_texto_siguiente, fonts_get_system_font(FONT_KEY_GOTHIC_18));
...
void highscores_window_load(Window *window) {
    ...
    init_muestra_highscores(window);
    muestra_highscores();
}
