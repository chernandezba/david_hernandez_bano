...
//queda :implementar que aparezca reloj (variable s_reloj) aleatoriamente en modo tiempo. animación
//de caida del reloj puesto en s_reloj_animaccaida , array de 4 elementos.
//que incremente el tiempo disponible . verificar modo de juego por tiempo.
//mirar de poder incrementar el tiempo si se recoge ciertos objetos o al sumar ciertos puntos).
//que se pueda configurar velocidad de aceleración de paleta
//mensajes en multiidioma, falta actualizar mensajes de waray
//testear hacer que vibre (seleccionable que vibre o no) cuando una gota cae
