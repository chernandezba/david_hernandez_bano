...
void pon_juego()  {
    ...
    if (gconfig.modojuego==MODO_JUEGO_TIEMPO) {
        ...
        max_objetos=5; //número de objetos iniciales 
        mtiempoqueda=90; //empezamos con 90 segundos
