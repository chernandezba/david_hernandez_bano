...
if (VENTANASEL->tipo_border!=NOBORDER)
  //si la ventana tiene marco o marco y sombra
...
//teclasalir:puntero acabado con 0000h a las teclas con las cuales saldra
	...
	switch(tec)  {
	  ...
	  case RIGHT:if (pun<longitud) {
		...
		default:if (pun<longitud && tec>=minimo && tec<=maximo) {
					 ...
					 if (pun<longitud-1) {
						copiamem(buffer,psalida,longitud-pun);
